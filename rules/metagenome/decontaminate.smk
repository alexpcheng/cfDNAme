...
rule decontaminate:
    ...
    output:
        ...
        r2_CT = temp('sample_output/decontaminate/{sample}.CT_R2.fastq'),
        r1_pass1 = temp('sample_output/decontaminate/{sample}.pass1_R1.fastq'),
        r2_pass1 = temp('sample_output/decontaminate/{sample}.pass1_R2.fastq'),
        r1_pass2 = temp('sample_output/decontaminate/{sample}.pass2_R1.fastq'),
        r2_pass2 = temp('sample_output/decontaminate/{sample}.pass2_R2.fastq'),
        decon_r1 = temp('sample_output/decontaminate/{sample}_decontaminated_R1.fastq'),
        decon_r2 = temp('sample_output/decontaminate/{sample}_decontaminated_R2.fastq'),
        nonhumanfa_r1 = temp('sample_output/nonhuman_fasta/R1/{sample}_R1.fa'),
        nonhumanfa_r2 = temp('sample_output/nonhuman_fasta/R2/{sample}_R2.fa')
    resources:
        mem_mb=80000
    params:
    ...
    shell:
        ...
        if [[ $seq_type == 2x* ]]; then
            ...
            python scripts/metagenome/insilico_conversion.py {input.unmapped_R2} {output.r2_CT} R2
            ...
            echo "This was processed as a single-end dataset so this is just a fun placeholder file" > {output.r2_CT}
            echo "This was processed as a single-end dataset so this is just a fun placeholder file" > {output.r2_pass1}
            echo "This was processed as a single-end dataset so this is just a fun placeholder file" > {output.r2_pass2}
            echo "This was processed as a single-end dataset so this is just a fun placeholder file" > {output.decon_r2}
            echo "This was processed as a single-end dataset so this is just a fun placeholder file" > {output.nonhumanfa_r2}
        fi
