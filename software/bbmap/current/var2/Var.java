...
//	static final int NOCALL=0, SUB=1, DEL=2, INS=3;
	...
	public static final String[] typeArray=new String[] {"INS","NOCALL","SUB","DEL","LJUNCT","RJUNCT","BJUNCT","COMPOUND"};
	public static final int INS=0, NOCALL=1, SUB=2, DEL=3, LJUNCT=4, RJUNCT=5, BJUNCT=6, COMPOUND=7;
...
//			if(n<=12){System.err.println();}
	...
	static {
		...
		typeInitialArray['C']=COMPOUND;
	}
	
	public static final String varFormat="1.2";
