...
//			assert(cardinality==r.countNocalls() || y>0) : cardinality+", "+r.countNocalls()+"\n"+r.length()+"\n"+bs+"\n"+r;//123
		...
		public final boolean passesVariantFilter(Read r){
			...
			ArrayList<Var> list=CallVariants.findUniqueSubs(r, (SamLine)r.obj, varMap, scafMap, maxBadSubAlleleDepth, maxBadAlleleFraction, minBadSubReadDepth, minBadSubEDist);
