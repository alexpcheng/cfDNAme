...
def tissue_DMR_per_chr(chr, tissue_group):
    files_to_compare = glob.glob(f'/workdir/apc88/GVHD/Reference_Methylomes/sandbox/MethylMatrix/{chr}/*{tissue_group}_*') #final '_' makes sure there wildcards differentiate G1 from G11, G12, etc.
...
def merge_DMR_per_chr(autosomal_chr, tissue_group):
    out_file = f'sandbox/MethylMatrix/golden_markers/{tissue_group}_multi_intersect.bed'
